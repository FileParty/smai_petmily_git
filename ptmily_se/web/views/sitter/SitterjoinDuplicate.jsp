...
<%@ page import=
"
com.petmily.user.model.vo.User"
%>
...
<section>
	<article>
		...
		<div id="checkid-container">
			...
			<%} else {%>
				<br/>
				<div id="tp">해당 아이디는 이미 사용 중 입니다.</div>
				<br/>
				<hr id="hr2">
				<div id="row">
...
<script>
	...
	function fn_duplicate(){
		...
		console.log("userId가 뜹니까: "+userId);
		location.replace('<%=request.getContextPath()%>/SitterIdDuplicate?user_Id='+userId);
	}
		...
		function setUserId(){
			...
			opener.document.querySelector("#user_id").value='<%=userId%>';
			self.close();	
		}
